...
public class Lab7AboutBox extends javax.swing.JDialog
{
  public Lab7AboutBox(java.awt.Frame parent)
  {
    super(parent);
    initComponents();
  ...
  private void initComponents() {
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(lab7.Lab7App.class).getContext().getResourceMap(Lab7AboutBox.class);
    setTitle(resourceMap.getString("title")); // NOI18N
    setModal(true);
    setName("aboutBox"); // NOI18N
    setResizable(false);

    javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(lab7.Lab7App.class).getContext().getActionMap(Lab7AboutBox.class, this);
