...
public class Lab7View extends FrameView
{
  ...
  public void showAboutBox()
  {
    if(aboutBox == null)
    {
      JFrame mainFrame = Lab7App.getApplication().getMainFrame();
      aboutBox = new Lab7AboutBox(mainFrame);
      aboutBox.setLocationRelativeTo(mainFrame);
    }
    Lab7App.getApplication().show(aboutBox);
  }
  ...
  private void initComponents() {
    ...
    adminPanel = new lab7.AdminPanel();
    ownerPanel = new lab7.OwnerPanel();
    guestPanel = new lab7.GuestPanel();
    ...
    ownerPanel.setName("ownerPanel"); // NOI18N
    tabbedPane.addTab(resourceMap.getString("ownerPanel.TabConstraints.tabTitle"), ownerPanel); // NOI18N

    guestPanel.setName("guestPanel"); // NOI18N
    tabbedPane.addTab(resourceMap.getString("guestPanel.TabConstraints.tabTitle"), guestPanel); // NOI18N
    ...
    javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(lab7.Lab7App.class).getContext().getActionMap(Lab7View.class, this);
  ...
  private lab7.AdminPanel adminPanel;
  private lab7.GuestPanel guestPanel;
  private javax.swing.JPanel mainPanel;
  private javax.swing.JMenuBar menuBar;
  private lab7.OwnerPanel ownerPanel;
